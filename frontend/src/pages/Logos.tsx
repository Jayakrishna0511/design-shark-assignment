...
const logosFiles = [
  { name: 'logo1.png', size: '320 KB', src: '/uploads/logo1.png' },
  { name: 'logo2.jpg', size: '540 KB', src: '/uploads/logo2.jpg' },
  { name: 'logo3.svg', size: '180 KB', src: '/uploads/logo3.svg' },
];
    ...
    <Box sx={{ padding: 3, backgroundColor: '#121212', minHeight: '100vh', marginLeft: '220px' }}>
      <Box display="flex" justifyContent="space-between" mb={3}>
        <Typography variant="h6" color="#fff">
          {logosFiles.length} file(s) available
        </Typography>
        <Button
          variant="contained"
