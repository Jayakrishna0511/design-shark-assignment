...
const brochureFiles = [
  { name: 'brochure1.jpg', size: '1.2 MB', src: '/uploads/brochure1.jpg' },
  { name: 'brochure2.jpg', size: '1.5 MB', src: '/uploads/brochure2.jpg' },
  { name: 'brochure3.jpg', size: '2.0 MB', src: '/uploads/brochure3.jpg' },
];
    ...
    <Box sx={{ padding: 3, backgroundColor: '#121212', minHeight: '100vh', marginLeft: '220px' }}>
      <Box display="flex" justifyContent="space-between" mb={3}>
        <Typography variant="h6" color="#fff">
          {brochureFiles.length} file(s) available
        </Typography>
        <Button
          variant="contained"
