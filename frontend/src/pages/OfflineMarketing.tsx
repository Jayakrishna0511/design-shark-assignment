...
const offlineFiles = [
  { name: 'poster1.jpg', size: '1.5 MB', src: '/uploads/poster1.jpg' },
  { name: 'flyer1.png', size: '900 KB', src: '/uploads/flyer1.png' },
  { name: 'leaflet1.jpg', size: '1.8 MB', src: '/uploads/leaflet1.jpg' },
];

const OfflineMarketing: React.FC = () => {
    ...
    <Box sx={{ padding: 3, backgroundColor: '#121212', minHeight: '100vh', marginLeft: '220px' }}>
      <Box display="flex" justifyContent="space-between" mb={3}>
        <Typography variant="h6" color="#fff">
          {offlineFiles.length} file(s) available
        </Typography>
        <Button
          variant="contained"
        ...
        {offlineFiles.map((file, idx) => (
          <Grid item key={idx} xs={12} sm={6} md={3}>
            <Card sx={{ backgroundColor: '#1e1e1e', color: '#fff' }}>
              <CardMedia component="img" height="140" image={file.src} alt={file.name} />
              <CardContent>
