...
const staticFiles = [
  { name: '11.2.png', size: '2.13 MB', src: '/uploads/11.2.png' },
  { name: '12.png', size: '2.77 MB', src: '/uploads/12.png' },
  { name: '13.2.png', size: '4.24 MB', src: '/uploads/13.2.png' },
];

const StaticPosts: React.FC = () => {
    ...
    <Box sx={{ padding: 3, backgroundColor: '#121212', minHeight: '100vh', marginLeft: '220px' }}>
      <Box display="flex" justifyContent="space-between" mb={3}>
        <Typography variant="h6" color="#fff">
          {staticFiles.length} file(s) available
        </Typography>
        <Button
          variant="contained"
